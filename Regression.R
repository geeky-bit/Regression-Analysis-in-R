require(data.table)
Happiness_Data=data.table(read.csv('2016.csv')) # similarly we can do analysis for 2015.csv and 2017.csv 
...
#In this example, I add lengths of country names plus some offset(try setting different offsets)
...
#Now, lets do some visualization of the residuals
